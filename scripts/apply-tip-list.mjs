...
const part5Vo =
  "Part five. Put the stone on the pile. Cairn takes the finished block and puts it on the stack. The pile is the record. Not the mood. Not the Tuesday glow. A stone is a session that happened. Cairn can see it. Tomorrow the pile is still there even if Thursday comes back. That is the point of a cairn. Marks on a path. Not proof of a soulmate. Cairn does not need a new species of work. He needs another stone. He places it where he can see it. A note. A commit. A crossed line. The stack gets taller by one. That height is the only proof Cairn trusts after a cold Thursday. Mood lies. The pile does not. He leaves the room with a taller cairn than he entered.";
...
const scenes = [
  hook,
  {
    ...
    speechLed: true,
    beats: beats([
      { pose: "present", caption: "FIXED INTEREST" },
      { pose: "slump", caption: "DULL THURSDAY" },
      { pose: "slump", caption: "THE TRAP" },
      { pose: "react", caption: "NOT A VERDICT" },
      { pose: "point", caption: "KEEP THE FOLDER" },
      { pose: "listen", caption: "NAME THE THEORY" },
      { pose: "present", caption: "SIT BACK DOWN" },
    ]),
  },
  {
    id: "part2",
    ...
    speechLed: true,
    beats: beats([
      { pose: "present", caption: "INTERESTS DEVELOP" },
      { pose: "listen", caption: "GROWN NOT FOUND" },
  ...
  },
  {
    ...
    speechLed: true,
    beats: beats([
      { pose: "present", caption: "HARD ≠ WRONG" },
      { pose: "slump", caption: "NOT EVIDENCE" },
      { pose: "slump", caption: "THE BASKET" },
      { pose: "point", caption: "KEEP THE HANDS" },
      { pose: "point", caption: "CAIRN STAYS" },
      { pose: "react", caption: "LOAD NOT VERDICT" },
      { pose: "present", caption: "ANSWER WITH THE SESSION" },
    ]),
  },
  {
    id: "part4",
  ...
  },
  {
    ...
    speechLed: true,
    beats: beats([
      { pose: "present", caption: "STONE ON THE PILE" },
      { pose: "listen", caption: "THE RECORD" },
      { pose: "slump", caption: "NOT THE MOOD" },
      { pose: "point", caption: "MARKS ON A PATH" },
      { pose: "point", caption: "ANOTHER STONE" },
      { pose: "react", caption: "MOOD LIES" },
      { pose: "present", caption: "TALLER CAIRN" },
    ]),
  },
  {
    id: "end",
